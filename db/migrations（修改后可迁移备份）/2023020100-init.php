    ...
    public function up(): int
    {
        DB::getPdo()->exec(
            ...
            CREATE TABLE `hourly_usage` (
                `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
                `user_id` bigint(20) unsigned NOT NULL DEFAULT 0 COMMENT '用户ID',
                `date` date NOT NULL DEFAULT '1989-06-04' COMMENT '记录日期',
                `usage` longtext COMMENT '流量用量',
                PRIMARY KEY (`id`),
                KEY `user_id` (`user_id`),
                KEY `date` (`date`)
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
            ...
            CREATE TABLE `node` (
                ...
                `custom_config` longtext COMMENT '自定义配置',
                ...
                `dynamic_rate_config` longtext COMMENT '动态流量倍率配置',
            ...
            CREATE TABLE `order` (
                ...
                `product_content` longtext COMMENT '商品内容',
            ...
            CREATE TABLE `user_coupon` (
                ...
                `content` longtext COMMENT '优惠码内容',
                `limit` longtext COMMENT '优惠码限制',
