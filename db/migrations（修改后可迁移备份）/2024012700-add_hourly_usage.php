...
return new class() implements MigrationInterface {
    public function up(): int
    {
        ...
        $pdo->exec("
            CREATE TABLE IF NOT EXISTS `hourly_usage` (
                ...
                `usage` longtext NOT NULL COMMENT '流量用量',
                PRIMARY KEY (`id`),
                KEY `user_id` (`user_id`)
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
        ");
        
        // 删除旧表 user_hourly_usage
        $pdo->exec('DROP TABLE IF EXISTS `user_hourly_usage`');
    ...
    public function down(): int
    {
        ...
        // 删除 hourly_usage 表
        $pdo->exec('DROP TABLE IF EXISTS `hourly_usage`');
